...
uint16_t readExternalPressure() {
  ...
  //Sealevel 14.6 psi
  double temp_ext = 0.0;
  temp_ext = 6895 * ((25.0 * 6.144 * (adc0 / 32768.0) - 25.0)); //Convert to Pascal
...
void led_init() {
#ifdef SOFTPWM
  Palatis::SoftPWM.begin(200); //200Hz
  for (int i = 0; i < 10; i++) {
    colour(i);
    delay(200);
  }
...
void setcolour(int red, int green, int blue) {
  Palatis::SoftPWM.set(RED, red);
  Palatis::SoftPWM.set(GREEN, green);
  Palatis::SoftPWM.set(BLUE, blue);
}
